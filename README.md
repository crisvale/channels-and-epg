...
| --- | --- | ---: | --- |
| France | `epg/france.xml.gz` | 956 | Canal+, Orange, SFR, Free |
| United Kingdom | `epg/united-kingdom.xml.gz` | 559 | Freeview, Freesat, Sky UK, Virgin TV Go, EE TV |
| Germany | `epg/germany.xml.gz` | 732 | Magenta TV, Sky DE, waipu.tv |
