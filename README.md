...
| Germany | `epg/germany.xml.gz` | 736 | Magenta TV, Sky DE, waipu.tv |
| Congo | `epg/congo.xml.gz` | 355 | Canal+ Congo |
| Spain | `epg/spain.xml.gz` | 555 | Tivify, RTVE, Orange, Movistar Plus+, Atresplayer, AgileTV (R, Telecable, SIMple, Euskaltel) |
